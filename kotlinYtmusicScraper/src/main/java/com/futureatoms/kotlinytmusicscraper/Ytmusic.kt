...
import com.futureatoms.kotlinytmusicscraper.encoder.brotli
...
import com.futureatoms.kotlinytmusicscraper.models.YouTubeClient
import com.futureatoms.kotlinytmusicscraper.models.YouTubeClient.Companion.ANDROID_MUSIC
import com.futureatoms.kotlinytmusicscraper.models.YouTubeClient.Companion.IOS
...
import com.futureatoms.kotlinytmusicscraper.models.body.AccountMenuBody
import com.futureatoms.kotlinytmusicscraper.models.body.BrowseBody
import com.futureatoms.kotlinytmusicscraper.models.body.CreatePlaylistBody
import com.futureatoms.kotlinytmusicscraper.models.body.EditPlaylistBody
import com.futureatoms.kotlinytmusicscraper.models.body.FormData
import com.futureatoms.kotlinytmusicscraper.models.body.GetQueueBody
import com.futureatoms.kotlinytmusicscraper.models.body.GetSearchSuggestionsBody
import com.futureatoms.kotlinytmusicscraper.models.body.LikeBody
import com.futureatoms.kotlinytmusicscraper.models.body.NextBody
import com.futureatoms.kotlinytmusicscraper.models.body.PlayerBody
import com.futureatoms.kotlinytmusicscraper.models.body.SearchBody
import com.futureatoms.kotlinytmusicscraper.utils.CurlLogger
import com.futureatoms.kotlinytmusicscraper.utils.KtorToCurl
import com.futureatoms.kotlinytmusicscraper.utils.parseCookieString
import com.futureatoms.kotlinytmusicscraper.utils.sha1
...
//    --data-raw '["O43z0dpjhgX20SCx4KAo"]'
    ...
    suspend fun checkForUpdate() =
        httpClient.get("https://api.github.com/repos/futureatoms/BevyBeats/releases/latest") {
            contentType(ContentType.Application.Json)
        }
