package com.futureatoms.kotlinytmusicscraper

import android.util.Log
import com.arthenica.ffmpegkit.FFmpegKit
import com.arthenica.ffmpegkit.ReturnCode
import com.futureatoms.kotlinytmusicscraper.extension.toListFormat
import com.futureatoms.kotlinytmusicscraper.models.AccountInfo
...
import com.futureatoms.kotlinytmusicscraper.models.GridRenderer
import com.futureatoms.kotlinytmusicscraper.models.MediaType
import com.futureatoms.kotlinytmusicscraper.models.MusicCarouselShelfRenderer
...
import com.futureatoms.kotlinytmusicscraper.models.ReturnYouTubeDislikeResponse
import com.futureatoms.kotlinytmusicscraper.models.Run
import com.futureatoms.kotlinytmusicscraper.models.SearchSuggestions
import com.futureatoms.kotlinytmusicscraper.models.SongInfo
...
import com.futureatoms.kotlinytmusicscraper.models.YTItemType
import com.futureatoms.kotlinytmusicscraper.models.YouTubeClient.Companion.TVHTML5
import com.futureatoms.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB
import com.futureatoms.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB_REMIX
import com.futureatoms.kotlinytmusicscraper.models.YouTubeLocale
import com.futureatoms.kotlinytmusicscraper.models.getContinuation
import com.futureatoms.kotlinytmusicscraper.models.oddElements
import com.futureatoms.kotlinytmusicscraper.models.response.AccountMenuResponse
import com.futureatoms.kotlinytmusicscraper.models.response.AddItemYouTubePlaylistResponse
import com.futureatoms.kotlinytmusicscraper.models.response.BrowseResponse
import com.futureatoms.kotlinytmusicscraper.models.response.CreatePlaylistResponse
import com.futureatoms.kotlinytmusicscraper.models.response.DownloadProgress
import com.futureatoms.kotlinytmusicscraper.models.response.GetQueueResponse
import com.futureatoms.kotlinytmusicscraper.models.response.GetSearchSuggestionsResponse
import com.futureatoms.kotlinytmusicscraper.models.response.LikeStatus
import com.futureatoms.kotlinytmusicscraper.models.response.NextAndroidMusicResponse
import com.futureatoms.kotlinytmusicscraper.models.response.NextResponse
import com.futureatoms.kotlinytmusicscraper.models.response.PipedResponse
import com.futureatoms.kotlinytmusicscraper.models.response.PlayerResponse
import com.futureatoms.kotlinytmusicscraper.models.response.SearchResponse
import com.futureatoms.kotlinytmusicscraper.models.response.toLikeStatus
import com.futureatoms.kotlinytmusicscraper.models.bevybeats.GithubResponse
import com.futureatoms.kotlinytmusicscraper.models.sponsorblock.SkipSegments
import com.futureatoms.kotlinytmusicscraper.models.youtube.GhostResponse
import com.futureatoms.kotlinytmusicscraper.models.youtube.Transcript
import com.futureatoms.kotlinytmusicscraper.models.youtube.YouTubeInitialPage
import com.futureatoms.kotlinytmusicscraper.pages.AlbumPage
import com.futureatoms.kotlinytmusicscraper.pages.ArtistPage
import com.futureatoms.kotlinytmusicscraper.pages.ArtistSection
import com.futureatoms.kotlinytmusicscraper.pages.BrowseResult
import com.futureatoms.kotlinytmusicscraper.pages.ExplorePage
import com.futureatoms.kotlinytmusicscraper.pages.MoodAndGenres
import com.futureatoms.kotlinytmusicscraper.pages.NextPage
import com.futureatoms.kotlinytmusicscraper.pages.NextResult
import com.futureatoms.kotlinytmusicscraper.pages.PlaylistContinuationPage
import com.futureatoms.kotlinytmusicscraper.pages.PlaylistPage
import com.futureatoms.kotlinytmusicscraper.pages.RelatedPage
import com.futureatoms.kotlinytmusicscraper.pages.SearchPage
import com.futureatoms.kotlinytmusicscraper.pages.SearchResult
import com.futureatoms.kotlinytmusicscraper.pages.SearchSuggestionPage
import com.futureatoms.kotlinytmusicscraper.parser.fromPlaylistContinuationToTracks
import com.futureatoms.kotlinytmusicscraper.parser.fromPlaylistToTrack
import com.futureatoms.kotlinytmusicscraper.parser.fromPlaylistToTrackWithSetVideoId
import com.futureatoms.kotlinytmusicscraper.parser.getContinuePlaylistContinuation
import com.futureatoms.kotlinytmusicscraper.parser.getPlaylistContinuation
import com.futureatoms.kotlinytmusicscraper.parser.getReloadParams
import com.futureatoms.kotlinytmusicscraper.parser.getSuggestionSongItems
import com.futureatoms.kotlinytmusicscraper.parser.hasReloadParams
import com.futureatoms.kotlinytmusicscraper.utils.CustomNewPipeDownloader
 ...
 * This library is from [z-huang/InnerTune] and I just modified it to comply with BevyBeats
 *
 * Here is the object that can create all request to YouTube Music and Spotify in BevyBeats
...
class YouTube {
     ...
     * In BevyBeats, I use this function to parsing Home, Playlist, Album data instead using [album], [playlist], [artist] function
                                ...
                                if (!videoProgress.first || !audioProgress.first) {
                                    ...
                                    val command =
                                        listOf(
                                            ...
                                            "1:a:0",
                                            "-shortest",
                                            "$filePath-BevyBeats.mp4",
                                        ).joinToString(" ")

                                    if (FileSystem.SYSTEM.exists("$filePath-BevyBeats.mp4".toPath())) {
                                        FileSystem.SYSTEM.delete("$filePath-BevyBeats.mp4".toPath())
                                    }
