package com.futureatoms.bevybeats.extension
...
import com.futureatoms.bevybeats.common.SETTINGS_FILENAME
...
import com.futureatoms.bevybeats.data.model.browse.artist.ResultSong
import com.futureatoms.bevybeats.data.model.browse.artist.ResultVideo
...
import com.futureatoms.bevybeats.viewModel.ArtistScreenData
...
fun com.futureatoms.lyricsproviders.models.lyrics.Lyrics.toLyrics(): Lyrics {
...
fun com.futureatoms.spotify.model.response.spotify.SpotifyLyricsResponse.toLyrics(): Lyrics {
    val lines: ArrayList<Line> = arrayListOf()
    this.lyrics.lines.forEach {
        lines.add(
            Line(
