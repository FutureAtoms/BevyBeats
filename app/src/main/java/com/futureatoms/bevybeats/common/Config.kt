package com.futureatoms.bevybeats.common
...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "BevyBeats Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "BevyBeats Playback Notification ID"
}
