package com.futureatoms.bevybeats.data.repository

import android.content.Context
import android.util.Log
import androidx.media3.common.util.UnstableApi
import com.futureatoms.kotlinytmusicscraper.YouTube
import com.futureatoms.kotlinytmusicscraper.extension.verifyYouTubePlaylistId
...
import com.futureatoms.kotlinytmusicscraper.parser.getPlaylistRadioEndpoint
import com.futureatoms.kotlinytmusicscraper.parser.getPlaylistShuffleEndpoint
import com.futureatoms.lyricsproviders.LyricsClient
import com.futureatoms.lyricsproviders.models.response.MusixmatchCredential
import com.futureatoms.lyricsproviders.models.response.MusixmatchTranslationLyricsResponse
import com.futureatoms.lyricsproviders.models.response.SearchMusixmatchResponse
import com.futureatoms.bevybeats.R
import com.futureatoms.bevybeats.common.QUALITY
import com.futureatoms.bevybeats.common.VIDEO_QUALITY
import com.futureatoms.bevybeats.data.dataStore.DataStoreManager
import com.futureatoms.bevybeats.data.db.LocalDataSource
import com.futureatoms.bevybeats.data.db.MusicDatabase
...
import com.futureatoms.bevybeats.data.model.browse.album.AlbumBrowse
import com.futureatoms.bevybeats.data.model.browse.album.Track
import com.futureatoms.bevybeats.data.model.browse.artist.ArtistBrowse
...
import com.futureatoms.bevybeats.data.model.explore.mood.Genre
import com.futureatoms.bevybeats.data.model.explore.mood.Mood
import com.futureatoms.bevybeats.data.model.explore.mood.MoodsMoment
...
import com.futureatoms.bevybeats.data.model.home.HomeItem
import com.futureatoms.bevybeats.data.model.home.chart.Chart
import com.futureatoms.bevybeats.data.model.metadata.Lyrics
...
import com.futureatoms.bevybeats.data.model.searchResult.songs.SongsResult
import com.futureatoms.bevybeats.data.model.searchResult.songs.Thumbnail
import com.futureatoms.bevybeats.data.model.searchResult.videos.VideosResult
import com.futureatoms.bevybeats.data.parser.parseAlbumData
import com.futureatoms.bevybeats.data.parser.parseArtistData
import com.futureatoms.bevybeats.data.parser.parseChart
import com.futureatoms.bevybeats.data.parser.parseGenreObject
import com.futureatoms.bevybeats.data.parser.parseLibraryPlaylist
import com.futureatoms.bevybeats.data.parser.parseMixedContent
import com.futureatoms.bevybeats.data.parser.parseMoodsMomentObject
import com.futureatoms.bevybeats.data.parser.parseNewRelease
import com.futureatoms.bevybeats.data.parser.parsePlaylistData
import com.futureatoms.bevybeats.data.parser.parsePodcast
import com.futureatoms.bevybeats.data.parser.parsePodcastContinueData
import com.futureatoms.bevybeats.data.parser.parsePodcastData
import com.futureatoms.bevybeats.data.parser.parseSetVideoId
import com.futureatoms.bevybeats.data.parser.search.parseSearchAlbum
import com.futureatoms.bevybeats.data.parser.search.parseSearchArtist
import com.futureatoms.bevybeats.data.parser.search.parseSearchPlaylist
import com.futureatoms.bevybeats.data.parser.search.parseSearchSong
import com.futureatoms.bevybeats.data.parser.search.parseSearchVideo
import com.futureatoms.bevybeats.data.parser.toListThumbnail
import com.futureatoms.bevybeats.data.type.PlaylistType
import com.futureatoms.bevybeats.data.type.RecentlyType
import com.futureatoms.bevybeats.extension.bestMatchingIndex
import com.futureatoms.bevybeats.extension.isNetworkAvailable
import com.futureatoms.bevybeats.extension.toListTrack
import com.futureatoms.bevybeats.extension.toLyrics
import com.futureatoms.bevybeats.extension.toTrack
import com.futureatoms.bevybeats.service.test.source.MergingMediaSourceFactory
import com.futureatoms.bevybeats.utils.Resource
import com.futureatoms.bevybeats.viewModel.FilterState
import com.futureatoms.spotify.Spotify
...
//                            }
    ...
    suspend fun getCanvas(
        videoId: String,
        duration: Int,
    ): Flow<com.futureatoms.spotify.model.response.spotify.CanvasResponse?> =
        flow {
            runCatching {
