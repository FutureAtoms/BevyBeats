...
import com.futureatoms.bevybeats.data.model.explore.mood.genre.ItemsSong
import com.futureatoms.bevybeats.data.model.explore.mood.genre.Title
import com.futureatoms.bevybeats.data.model.explore.mood.moodmoments.Content
        ...
        if (items != null) {
            for (item in items) {
                if (item.musicCarouselShelfRenderer != null) {
                    ...
                    val listContent: MutableList<com.futureatoms.bevybeats.data.model.explore.mood.genre.Content> = mutableListOf()
                    if (!contents.isNullOrEmpty()) {
                        for (content in contents) {
                            if (content.musicResponsiveListItemRenderer != null) {
                                // Song
                                ...
                                val playlistBrowseId =
                                    content.musicTwoRowItemRenderer
                                        ...
                                        ?.browseId
                                listContent.add(
                                    com.futureatoms.bevybeats.data.model.explore.mood.genre.Content(
                                        playlistBrowseId = playlistBrowseId ?: "",
