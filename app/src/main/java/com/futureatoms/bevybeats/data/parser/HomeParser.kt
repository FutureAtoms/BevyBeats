...
fun Thumbnail.toThumbnail(): com.futureatoms.bevybeats.data.model.searchResult.songs.Thumbnail =
    com.futureatoms.bevybeats.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.futureatoms.bevybeats.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.futureatoms.bevybeats.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
